...
| R4 | ~~`/api/appointments/[id]/payment-info` — tgid HMAC tekshiruvisiz~~ — **YOPILDI** | ~~🟡~~ ✅ | 403→404 tuzatildi. tgid HMAC tekshiruvi hali yo'q (Wave 4). | — | webapp-auth pattern keyingi bosqichda | Wave 4 |
