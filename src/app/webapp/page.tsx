          ...
          <div className="flex gap-2">
            <div className="flex-1 relative">
              ...
              <button
                ...
                className="cta-yangi-bron w-full py-3.5 rounded-2xl text-white font-semibold text-sm active:scale-95 transition-all"
              >
                <span className="relative z-[1]">➕ Yangi bron</span>
              </button>
            </div>
            <button
              onClick={() => {
